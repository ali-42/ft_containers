...
/*   Updated: 2022/09/28 22:33:24 by ali              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	prm(ft::map<int, std::string>::iterator first, ft::map<int, std::string>::iterator last)
{
	while (first != last)
	{
...
void	print_vector(const ft::vector<T>& v)
{
	...
	for (typename ft::vector<T>::const_iterator ftit = v.begin(); ftit != v.end(); ftit++)
...
template<class Key, class T>
void	print_mapElem(const ft::pair<Key, T>& elem)
{
...
{
	{
...

		{
			...
			base.push_back(42);
			base.push_back(84);
			ft::vector<int>::iterator baseBegin = base.begin();
			ft::vector<int>::iterator baseEnd = base.end();

			ft::vector<int> v(baseBegin, baseEnd);
...

	{
...

		{
			...
			ft::stack<std::string> s(v);
			print_stack(s);

			std::cout << std::endl << "copy constructor" << std::endl;

			ft::stack<std::string> cpy(s);
			print_stack(cpy);
		}
...

	{
		...
		v.push_back(ft::make_pair(0, "bla"));
		v.push_back(ft::make_pair(-21, "blu"));
		v.push_back(ft::make_pair(42, "bli"));
		v.push_back(ft::make_pair(21, "blo"));
...

	{
		...
		ft::map<int, std::string>::reverse_iterator iter= m.rend();
		print_mapElem(*(--iter));
	}
...

	{
		...
		m.insert(ft::make_pair(1, "second"));
		m.insert(ft::make_pair(2, "third"));
		std::cout << m.size() << std::endl;
	}
...

	{
		...
		ft::map<int, std::string> m;
		m.insert(ft::make_pair(0, "blu"));
		m.insert(ft::make_pair(1, "bli"));
		print_map(m);

		m.insert(ft::make_pair(-1, "blo"));
		m.insert(ft::make_pair(2, "bla"));
		print_map(m);

		std::cout << std::endl << "insert() by value (before and after)" << std::endl;

		m.insert(--m.end(), ft::make_pair(3, "ble"));
		m.insert(m.begin(), ft::make_pair(-2, "bly"));
		print_map(m);
		...
		ft::vector<ft::pair<int, std::string> > v;
		v.push_back(ft::make_pair(0, "blu"));
		v.push_back(ft::make_pair(1, "bli"));
		v.push_back(ft::make_pair(-1, "blo"));
		v.push_back(ft::make_pair(2, "bla"));
	...
	
	{
		...
		a.insert(ft::make_pair("A", 12445));
		a.insert(ft::make_pair("Stupid Key", -111));
		a.insert(ft::make_pair("qwerty", 42));

		ft::map<std::string, int> b;
		b.insert(ft::make_pair("dududu", 33));
		b.insert(ft::make_pair("wawawaw", -122));
		b.insert(ft::make_pair("0_0", 12314));
...

	{
		...
		for (ft::map<std::string, int>::iterator it = m.find("Key2"); it != m.end(); it++)
		...
		ft::map<std::string, int>::iterator it = m.equal_range("Key1").first;
		ft::map<std::string, int>::iterator it2 = m.equal_range("Key1").second;
		std::cout << it->first << " : " << it->second << std::endl;
...

	{
		...
		std::cout << m.value_comp()(ft::make_pair("arbre", 29), ft::make_pair("bateau", 42)) << std::endl;
		std::cout << m.value_comp()(ft::make_pair("bateau", 42), ft::make_pair("arbre", 29)) << std::endl;
	}
	...
	
	{
		...
		m.insert(ft::make_pair(42, "blu"));
		m.insert(ft::make_pair(21, "blo"));
		m.insert(ft::make_pair(84, "bla"));
		...
		m.insert(ft::make_pair(72, "bla"));
		print_comparisons(m, m2);

		std::cout << std::endl << "* different values *" << std::endl;
		m.erase(72);
		m.insert(ft::make_pair(84, "bli"));
		print_comparisons(m, m2);
	}
...

	{
		...
		for (int i = 0; i < 100000; i++)
		{
			...
			s.push(rand()%1000000);
			m.insert(ft::make_pair(rand()%1000000, rand()%1000000));
		}
		for (int i = 0; i < 100000; i++)
			m.find(rand()%1000000);
